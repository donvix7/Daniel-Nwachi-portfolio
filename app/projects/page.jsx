    ...
    <>
      ...
      <main className="p-10 flex flex-col gap-10">
        ...
        <section className="max-w-2xl flex flex-col gap-10 mt-20">
          <h1 className="text-6xl font-bold text-slate-900">Selected Works</h1>
        ...
        <section className="flex gap-8  items-center justify-between mt-20 border-t border-slate-300 pt-10 pb-20 my-20 ">
          <div className="max-w-md lex flex-col gap-8">
            <h2 className="font-bold text-4xl text-slate-900">Stay in the loop.</h2>
            <p className="text-gray-900 text-lg font-light mt-6">
              Occasional updates on design, utility, and the projects I'm working on. No noise, just signal.
            </p>
          </div>
          <form onSubmit={handleSubscribe} className="w-full md:w-auto flex flex-col sm:flex-row gap-stack-sm items-end sm:items-center">
